...
def test_resolve_endpoint_returns_404_when_the_essay_doesnt_exist(resolve_client):
    client = resolve_client(_RaisingDatabase(EssayNotFoundError("no such essay")))
...
def test_resolve_endpoint_returns_403_when_the_caller_doesnt_own_the_essay(resolve_client):
    client = resolve_client(_RaisingDatabase(EssayAccessDeniedError("not your essay")))
